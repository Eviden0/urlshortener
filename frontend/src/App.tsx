          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full">
              ...
              <div className='flex pt-4'>
                <Button type="submit" className='mx-auto'>生成短链接</Button>
              </div>
            </form>
          </Form>
        ...
        {shortUrl && (
          <div className="mt-8 p-4 border rounded-lg">
            ...
            <div className="flex items-center gap-2">
              <a href={shortUrl} target='_blank' className='hover:underline text-sky-600'><h2>{shortUrl}</h2></a>
              ...
              }} size={15} className='hover:cursor-pointer hover:shadow-lg hover:scale-105' />
